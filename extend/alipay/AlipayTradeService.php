...
use alipay\model\request\AlipayTradeCreateRequest;
use alipay\model\request\AlipayTradePagePayRequest;
use alipay\model\request\AlipayTradeWapPayRequest;
use alipay\model\request\AlipayTradePrecreateRequest;
use alipay\model\request\AlipayTradeQueryRequest;
use alipay\model\request\AlipayTradeRefundRequest;
use alipay\model\request\AlipayTradeCloseRequest;
use alipay\model\request\AlipayTradeFastpayRefundQueryRequest;
use alipay\model\result\AlipayF2FPrecreateResult;
use alipay\model\result\AlipayF2FQueryResult;
use alipay\model\result\AlipayF2FRefundResult;
use alipay\model\builder\AlipayTradeQueryContentBuilder;
...
//		$this->return_url = $alipay_config['return_url'];
	...
	public function writeLog($text) {
		...
		//$text = characet ( $text );
		//file_put_contents ( root_path()."extend/alipay/log/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
