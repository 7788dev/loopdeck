 ...
 private $crossCheckStateCount;
	...
	private function selectBestPatterns()
	{
		...
		if ($startSize > 3) {
			...
			usort($this->possibleCenters, Closure::fromCallable([$this, 'FurthestFromAverageComparator']));
		...
		if (count($this->possibleCenters) > 3) {
			...
			usort($this->possibleCenters, Closure::fromCallable([$this, 'CenterComparator']));
