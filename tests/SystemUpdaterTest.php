...
updaterCheck(ApplicationVersion::current() === '1.1.16', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.16', 'Template asset version was not loaded');
...
$stack = HandlerStack::create(new MockHandler([
    new Response(200, ['Content-Type' => 'text/plain'], "1.1.17\n"),
...
updaterCheck($status['current_version'] === '1.1.16', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.17', 'Status returned the wrong remote version');
