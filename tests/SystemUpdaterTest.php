...
updaterCheck(ApplicationVersion::current() === '1.1.2', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.2', 'Template asset version was not loaded');
...
$stack = HandlerStack::create(new MockHandler([
    new Response(200, ['Content-Type' => 'text/plain'], "1.1.3\n"),
...
updaterCheck($status['current_version'] === '1.1.2', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.3', 'Status returned the wrong remote version');
...
$fallbackStack = HandlerStack::create(new MockHandler([
    ...
    new Response(200, ['Content-Type' => 'text/plain'], "1.1.2\n"),
]));
...
updaterCheck($fallbackStatus['latest_version'] === '1.1.2', 'Fallback version source was not used');
