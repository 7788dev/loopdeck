...
INSERT INTO `cloud_tasks` (`id`, `type`, `name`, `describe`, `icon`, `execute_name`, `execute_url`, `execute_rate`, `more`, `state`, `vip`, `time`, `order`) VALUES
                                                                                                                                                                 ...
                                                                                                                                                                 (15, 'bilibili', '全局配置', '全局直播间ID配置', 'si si-compass', 'globalroom', NULL, '86400', 0, 1, 0, '2022-01-01 00:00:00', 1),
                                                                                                                                                                  (16, 'bilibili', '每日分享', '每日分享功能已下架', 'si si-paper-plane', 'shareaid', NULL, '86400', 0, 1, 1, '2022-01-01 00:00:00', 3),
                                                                                                                                                                 ...
                                                                                                                                                                 (19, 'netease', 'VIP成长任务', '黑胶乐签、VIP听歌与成长值领取', 'si si-diamond', 'vip_growth_task', NULL, '86400', 0, 1, 0, '2026-07-31 00:00:00', 7),
                                                                                                                                                                  (20, 'bilibili', '每日经验任务', '登录、观看、投币经验状态与经验日志核验（分享功能已下架）', 'si si-graduation', 'dailyexperience', NULL, '86400', 0, 1, 0, '2026-08-02 00:00:00', 2),
                                                                                                                                                                 (21, 'bilibili', '大会员每日经验', '按官方协议领取大会员每日经验，非大会员安全跳过', 'si si-diamond', 'vipexperience', NULL, '86400', 0, 1, 0, '2026-08-02 00:00:00', 3),
