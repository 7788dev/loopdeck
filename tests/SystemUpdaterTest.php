...
updaterCheck(ApplicationVersion::current() === '1.1.3', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.3', 'Template asset version was not loaded');
...
updaterCheck($status['current_version'] === '1.1.3', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.4', 'Status returned the wrong remote version');
...
updaterCheck($fallbackStatus['latest_version'] === '1.1.3', 'Fallback version source was not used');
