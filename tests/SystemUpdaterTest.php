...
updaterCheck(ApplicationVersion::current() === '1.1.22', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.22', 'Template asset version was not loaded');
...
$stack = HandlerStack::create(new MockHandler([
    new Response(200, ['Content-Type' => 'text/plain'], "1.1.23\n"),
...
updaterCheck($status['current_version'] === '1.1.22', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.23', 'Status returned the wrong remote version');
