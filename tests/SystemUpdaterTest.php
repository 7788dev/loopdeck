...
updaterCheck(ApplicationVersion::current() === '1.1.1', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.1', 'Template asset version was not loaded');
...
updaterCheck($status['current_version'] === '1.1.1', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.2', 'Status returned the wrong remote version');
