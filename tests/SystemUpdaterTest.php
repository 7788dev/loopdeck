...
updaterCheck(ApplicationVersion::current() === '1.1.9', 'Local VERSION was not loaded');
updaterCheck(app_version() === '1.1.9', 'Template asset version was not loaded');
...
$stack = HandlerStack::create(new MockHandler([
    new Response(200, ['Content-Type' => 'text/plain'], "1.1.10\n"),
...
updaterCheck($status['current_version'] === '1.1.9', 'Status returned the wrong local version');
updaterCheck($status['latest_version'] === '1.1.10', 'Status returned the wrong remote version');
