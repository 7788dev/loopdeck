...
class SMTP {
    ...
    public function __construct($relay_host, $smtp_port, $auth, $user, $pass , $ssl = false) {
        $this ->debug = false;
    ...
    public function send($to, $from, $subject = "", $body = "", $fromname = "God云任务", $reply = '', $cc = "", $bcc = "", $additional_headers = "") {
        if (empty($reply)) {
            $reply = $from;
        }
        $header = "";
